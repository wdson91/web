...
async def agendar_execucao(target_hours):
    ...
    while True:
        ...
        if current_time in target_hours:
            await main_vmz(current_time, array_datas, run_once=True)
            logging.info(f"A execução da main_vmz foi agendada para as {current_time}")
...
async def main():
    ...
    target_hours = ["07:00", "11:00", "16:15", "17:00"]
