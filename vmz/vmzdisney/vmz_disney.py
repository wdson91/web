...
async def coletar_precos_vmz_disney():
    ...
    async def join_vmz():
        ...
        # Nomes dos arquivos
        arquivo1 = os.path.join(diretorio_atual, 'vmz_disney_basicos.txt')
        arquivo2 = os.path.join(diretorio_atual, 'vmz_disney_dias.txt')
        ...
        #inserir_dados_no_banco(df_combinado, 'vmz_disney')
